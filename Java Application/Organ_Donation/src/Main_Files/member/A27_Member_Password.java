...
//Function class
public class A27_Member_Password extends javax.swing.JFrame {
    public A27_Member_Password(String e){
        initComponents();
        setIcon();
        getDetail(e);
    ...
    private void initComponents() {
        ...
        jPasswordField1.setToolTipText("Please enter your current password");
        ...
        jPasswordField2.setToolTipText("Enter your new password here");
    ...
    //Code for updating profile password
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        if(!(P2.equalsIgnoreCase(""))){
            if(P2.equals(P3)){
                if(P1.equals(PrePass)){
                    try{
                        ...
                        int r = stmt.executeUpdate("UPDATE member SET Password='"+P2+"' WHERE Email='"+Email+"'");
                        if(r==1){
            ...
            JOptionPane.showMessageDialog(this, "Please enter a new password.", "Passwords Missing", JOptionPane.ERROR_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/Icons/75px_cancel.png")));
