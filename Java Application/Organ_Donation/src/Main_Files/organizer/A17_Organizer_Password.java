...
//Function class
public class A17_Organizer_Password extends javax.swing.JFrame {
    public A17_Organizer_Password(String e){
        initComponents();
        setIcon();
        getDetail(e);
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(255, 81, 47));
        ...
        jLabel51.setToolTipText("Error Occured");
        ...
        kButton1.setToolTipText("Ready to change password");
        ...
        if(P2.equals(P3)){
            if(P1.equals(PrePass)){
                try{
                    ...
                    int r = stmt.executeUpdate("UPDATE organization SET Password='"+P2+"' WHERE Email='"+Email+"'");
                    if(r==1){
    ...
    private void getDetail(String email) {
        ...
        try{
            ...
            DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
            stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM organization WHERE Email='"+Email+"'");
            while (rs.next()) {
