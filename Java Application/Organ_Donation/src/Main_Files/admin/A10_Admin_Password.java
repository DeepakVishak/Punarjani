...
//Function class
public class A10_Admin_Password extends javax.swing.JFrame {
    public A10_Admin_Password(String e){
        initComponents();
        setIcon();
        CAInfo(e);
    ...
    private void initComponents() {
        ...
        kButton1.setToolTipText("Click here to change password");
    ...
    //Code for chanding administrator profile password
            ...
            if(!(P1.equalsIgnoreCase("")|P2.equalsIgnoreCase("")|P3.equalsIgnoreCase(""))){
                if(P1.equals(PrePass)){
                    try{
                        ...
                        int r = stmt.executeUpdate("UPDATE administrator SET Password='"+P2+"' WHERE Email='"+Email+"'");
                        if(r==1){
                            JOptionPane.showMessageDialog(this, "Your password have been sucessfully updated.", "Password Updated", JOptionPane.WARNING_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/Icons/75px_ok.png")));
                    ...
                    JOptionPane.showMessageDialog(this, "Please enter your current password correctly.", "Password Mismatch", JOptionPane.WARNING_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/Icons/75px_cancel.png")));
            }
            else
                JOptionPane.showMessageDialog(this, "Please fill all the fields to update your profile password.", "Missing Passwords", JOptionPane.WARNING_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/Icons/75px_cancel.png")));
        }
        else
            JOptionPane.showMessageDialog(this, "Entered passwords are different.\nPlease enter correct passwords to confirm your new password.", "Password Mismatch", JOptionPane.WARNING_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/Icons/75px_cancel.png")));
    ...
    private void CAInfo(String email) {
        ...
        try{
            ...
            DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
            stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM administrator WHERE Email='"+email+"'");
            while (rs.next()) {
